...
char pokemon(int n, int m, char a[][100], char you, int energy) {
    ...
    if(a[x-1][y] == '#' || energy<(a[x-1][y]-48) || (a[x-1][y]>=97 && a[x-1][y]<=122) || x-1>n || x-1<0){
        no=0;
        val[0]=-999;
    }
    if(a[x][y+1] == '#' || energy<(a[x][y+1]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || y+1>m || y+1<0){
        e=0;
        val[1]=-999;
    }
    if(a[x][y-1] == '#' || energy<(a[x][y-1]-48) || (a[x][y-1]>=97 && a[x][y-1]<=122) || y-1>m || y-1<0) {
    ...
    if (no==1) {
        ...
        while (a[x2][y]!='#' || (a[x2][y]<97 && a[x2][y]>122)){
            ...
            if (x2<0 || x2>n) break;
            if (a[x2][y]==' ') val[0]++;
            else if (a[x2][y]>=48 && a[x2][y]<=57) val[0]+=5+54/(a[x2][y]-30);
        }
    }
    if (e==1) {
        y1=y;
        while (a[x][y1]!='#' || (a[x][y1]<97 && a[x][y1]>122)){
            ...
            if (y1<0 || y1>m) break;
            if (a[x][y1]==' ') val[1]++;
            else if (a[x][y1]>=48 && a[x][y1]<=57) val[1]+=5+54/(a[x][y1]-30);
        }
    }
    if (w==1) {
        y2=y;
        while (a[x][y2]!='#' || (a[x][y2]<97 && a[x][y2]>122)){
            ...
            if (y2<0 || y2>m) break;
            if (a[x][y2]==' ') val[2]++;
            else if (a[x][y2]>=48 && a[x][y2]<=57) val[2]+=5+54/(a[x][y2]-30);
        }
    }
    if (s==1) {
        x1=x;
        while (a[x1][y]!='#' || (a[x1][y]<97 && a[x1][y]>122)){
            ...
            if (x1<0 || x1>n) break;
            if (a[x1][y]==' ') val[3]++;
            else if (a[x1][y]>=48 && a[x1][y]<=57) val[3]+=5+54/(a[x1][y]-30);
        }
    }
    int z;
