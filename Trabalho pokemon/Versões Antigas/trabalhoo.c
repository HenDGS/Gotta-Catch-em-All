...
char pokemon(int n, int m, char a[][100], char you, int energy) {
    ...
    if(a[x-1][y] == '#' || energy<(a[x-1][y]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || x-1>n || x-1<0) no=0;
    ...
    if(a[x+1][y] == '#' || energy<(a[x+1][y]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || x+1>n || x+1<0) s=0;
    /*//verificador de duas casas
    if(a[x-1][y] == '#' || energy<(a[x-1][y]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || x-1>n || x-1<0) no=0;
    if(a[x][y+1] == '#' || energy<(a[x][y+1]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || y+1>m || y+1<0) e=0;
    if(a[x][y-1] == '#' || energy<(a[x][y-1]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || y-1>m || y-1<0) w=0;
    if(a[x+1][y] == '#' || energy<(a[x+1][y]-48) || (a[x][y+1]>=97 && a[x][y+1]<=122) || x+1>n || x+1<0) s=0;
    //verificador de tres casas
    if(a[x][y+3] == '#' || energy<(a[x][y+3]-48) || (a[x][y+3]>=97 && a[x][y+3]<=122) || y+1>m || y+1<0) no=0;
    if(a[x+3][y] == '#' || energy<(a[x+3][y]-48) || (a[x][y+3]>=97 && a[x][y+3]<=122) || x+1>n || x+1<0) e=0;
    if(a[x-3][y] == '#' || energy<(a[x-3][y]-48) || (a[x][y+3]>=97 && a[x][y+3]<=122) || x-1>n || x-1<0) w=0;
    if(a[x][y-3] == '#' || energy<(a[x][y-3]-48) || (a[x][y+3]>=97 && a[x][y+3]<=122) || y-1>m || y-1<0) s=0;*/
    ...
    if (no==1) {
        ...
        while (a[x2][y]!='#' || (a[x2][y]<97 && a[x2][y]>122)){
            x2--;
            if (a[x2][y]==' ' || (a[x2][y]>=48 && a[x2][y]<=57)) val[0]++;
        }
    }
    if (e==1) {
        y1=y;
        while (a[x][y1]!='#' || (a[x][y1]<97 && a[x][y1]>122)){
            y1++;
            if (a[x][y1]==' ' || (a[x][y1]>=48 && a[x][y1]<=57)) val[1]++;
        }
    }
    if (w==1) {
        y2=y;
        while (a[x][y2]!='#' || (a[x][y2]<97 && a[x][y2]>122)){
            y2--;
            if (a[x][y2]==' ' || (a[x][y2]>=48 && a[x][y2]<=57)) val[2]++;
        }
    }
    if (s==1) {
        x1=x;
        while (a[x1][y]!='#' || (a[x1][y]<97 && a[x1][y]>122)){
            x1++;
            if (a[x1][y]==' ' || (a[x1][y]>=48 && a[x1][y]<=57)) val[3]++;
        }
    }
    int z;
